...
# save_fp <- "../Data-Populated/Data/C2C12.RData"
# save_csv<- "../Data-Populated/Data/C2C12.csv"
save_fp <- "../Data-Populated-Unfiltered/Data/C2C12.RData"
save_csv<- "../Data-Populated-Unfiltered/Data/C2C12.csv"
...
if (filtering) {
 ...
 dat.DE <- dat_raw[which(rowSums(abs(meanAbundance(dat_raw, groups)) > 2) > 0 & padj < 0.05),]
} else {
 dat.DE <- dat_raw
}
## Normalisation 0-1
