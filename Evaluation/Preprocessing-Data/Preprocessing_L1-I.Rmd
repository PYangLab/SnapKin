...
# save_fp <- "../Data-Populated/Data/L1-I.RData"
# save_csv<- "../Data-Populated/Data/L1-I.csv"
save_fp <- "../Data-Populated-Unfiltered/Data/L1-I.RData"
save_csv<- "../Data-Populated-Unfiltered/Data/L1-I.csv"
...
MAPK1.ids <- which(sites %in% removeSiteLoc(PhosR::PhosphoSite.mouse$MAPK1)) 
MTOR.ids <- which(sites %in% removeSiteLoc(PhosR::PhosphoSite.mouse$MTOR))
